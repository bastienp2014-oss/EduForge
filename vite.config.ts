...
export default defineConfig(() => {
  return {
    ...
    test: {
      ...
      exclude: ['**/node_modules/**', 'src/store/firestoreConfigRules.test.ts', 'src/store/useAppConfig.test.ts', 'marketing-site/src/lib/tenantApi.test.ts', 'src/shared/hierarchyRules.test.ts'],
    },
  };
});
